...
This package was generated by /home/sander/go/pkg/mod/github.com/openconfig/ygot@v0.22.1/genutil/names.go
...
import (
	...
	"github.com/stolsma/go-p4dpdk-vswitch/pkg/gnmi/internal/telemetry/openconfigacl"
	"github.com/stolsma/go-p4dpdk-vswitch/pkg/gnmi/internal/telemetry/openconfiginterfaces"
	"github.com/stolsma/go-p4dpdk-vswitch/pkg/gnmi/internal/telemetry/openconfigkeychain"
	"github.com/stolsma/go-p4dpdk-vswitch/pkg/gnmi/internal/telemetry/openconfiglacp"
	"github.com/stolsma/go-p4dpdk-vswitch/pkg/gnmi/internal/telemetry/openconfiglldp"
	"github.com/stolsma/go-p4dpdk-vswitch/pkg/gnmi/internal/telemetry/openconfignetworkinstance"
	"github.com/stolsma/go-p4dpdk-vswitch/pkg/gnmi/internal/telemetry/openconfigplatform"
	"github.com/stolsma/go-p4dpdk-vswitch/pkg/gnmi/internal/telemetry/openconfigqos"
	"github.com/stolsma/go-p4dpdk-vswitch/pkg/gnmi/internal/telemetry/openconfigroutingpolicy"
	"github.com/stolsma/go-p4dpdk-vswitch/pkg/gnmi/internal/telemetry/openconfigsystem"
)
...
// Path from root: "/acl"
func (n *DevicePath) Acl() *openconfigacl.AclPath {
	return &openconfigacl.AclPath{
...
func (n *DevicePath) ComponentAny() *openconfigplatform.ComponentPathAny {
	return &openconfigplatform.ComponentPathAny{
		NodePath: ygot.NewNodePath(
...
// Path from root: "/components/component"
// Name: string
func (n *DevicePath) Component(Name string) *openconfigplatform.ComponentPath {
	return &openconfigplatform.ComponentPath{
		NodePath: ygot.NewNodePath(
			[]string{"components", "component"},
...
// Name (wildcarded): string
func (n *DevicePath) InterfaceAny() *openconfiginterfaces.InterfacePathAny {
	return &openconfiginterfaces.InterfacePathAny{
		NodePath: ygot.NewNodePath(
...
// Path from root: "/interfaces/interface"
// Name: string
func (n *DevicePath) Interface(Name string) *openconfiginterfaces.InterfacePath {
	return &openconfiginterfaces.InterfacePath{
		NodePath: ygot.NewNodePath(
			[]string{"interfaces", "interface"},
			map[string]interface{}{"name": Name},
			n,
...
// Name (wildcarded): string
func (n *DevicePath) KeychainAny() *openconfigkeychain.KeychainPathAny {
	return &openconfigkeychain.KeychainPathAny{
		NodePath: ygot.NewNodePath(
...
// Path from root: "/keychains/keychain"
// Name: string
func (n *DevicePath) Keychain(Name string) *openconfigkeychain.KeychainPath {
	return &openconfigkeychain.KeychainPath{
		NodePath: ygot.NewNodePath(
			[]string{"keychains", "keychain"},
			map[string]interface{}{"name": Name},
			n,
...
// Path from root: "/lacp"
func (n *DevicePath) Lacp() *openconfiglacp.LacpPath {
	return &openconfiglacp.LacpPath{
		NodePath: ygot.NewNodePath(
			[]string{"lacp"},
			map[string]interface{}{},
			n,
...
// Path from root: "/lldp"
func (n *DevicePath) Lldp() *openconfiglldp.LldpPath {
	return &openconfiglldp.LldpPath{
		NodePath: ygot.NewNodePath(
			[]string{"lldp"},
			map[string]interface{}{},
			n,
...
// Name (wildcarded): string
func (n *DevicePath) NetworkInstanceAny() *openconfignetworkinstance.NetworkInstancePathAny {
	return &openconfignetworkinstance.NetworkInstancePathAny{
		NodePath: ygot.NewNodePath(
...
// Path from root: "/network-instances/network-instance"
// Name: string
func (n *DevicePath) NetworkInstance(Name string) *openconfignetworkinstance.NetworkInstancePath {
	return &openconfignetworkinstance.NetworkInstancePath{
		NodePath: ygot.NewNodePath(
			[]string{"network-instances", "network-instance"},
			map[string]interface{}{"name": Name},
			n,
...
// Path from root: "/qos"
func (n *DevicePath) Qos() *openconfigqos.QosPath {
	return &openconfigqos.QosPath{
		NodePath: ygot.NewNodePath(
			[]string{"qos"},
			map[string]interface{}{},
			n,
...
func (n *DevicePath) RoutingPolicy() *openconfigroutingpolicy.RoutingPolicyPath {
	return &openconfigroutingpolicy.RoutingPolicyPath{
		NodePath: ygot.NewNodePath(
...
func (n *DevicePath) System() *openconfigsystem.SystemPath {
	return &openconfigsystem.SystemPath{
		NodePath: ygot.NewNodePath(
			[]string{"system"},
			map[string]interface{}{},
			n,
